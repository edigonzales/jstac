...
//        super.fileName = "collection.json";
    ...
    public static Collection_V1 readFromFile(File collectionFile) throws IOException {
        ObjectMapper objectMapper = JacksonObjectMapperHolder.getInstance().getObjectMapper();
        Collection_V1 collection = objectMapper.readValue(collectionFile, Collection_V1.class);
